...
<td align = "center" colspan = "5"> 
	<font size="4" color="green"><b>빌린 도서 목록</b></font><br>
		<table border="1" width="100%" style = "text-align:center;">
			...
			<tr>
				<c:choose>		
					<c:when test="${empty MemberBookList}">
						<tr>
					...
					<c:when test = "${not empty MemberBookList}">
						<c:forEach var="book" items="${MemberBookList}">
							<tr>
...
<!-- 페이징  -->		
	...
	<c:if test="${startPageGroup > 1}">
			...
			</c:if> &nbsp;&nbsp; <a href = "n_main.do"><button>메인으로</button></a>
	</div>		
</td>			
